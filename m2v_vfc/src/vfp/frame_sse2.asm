...
; xmm6 - all 4
		...
		pmullw     xmm1, int16_all3 ; 3*c[1][x]
		pmullw     xmm5, xmm2       ; 7*c[2][x]
		pmullw     xmm2, int16_all3 ; 3*c[2][x]
		paddw      xmm4, xmm3       ; 7*c[1][x] + 1*c[3][x]
		paddw      xmm5, xmm0       ; 7*c[2][x] + 1*c[0][x]
		pmullw     xmm0, int16_all5 ; 5*c[0][x]
		pmullw     xmm3, int16_all5 ; 5*c[3][x]
